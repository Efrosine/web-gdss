...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $alternatives1 = collect([
            ['code' => 'A01', 'name' => 'Jovan', 'nip' => '1234567890'],
            ['code' => 'A02', 'name' => 'Fajar', 'nip' => '1234567890'],
            ['code' => 'A03', 'name' => 'Fahmi', 'nip' => '1234567890'],
            ['code' => 'A04', 'name' => 'Abed', 'nip' => '1234567890'],
            ['code' => 'A05', 'name' => 'Kaka', 'nip' => '1234567890'],
            ['code' => 'A06', 'name' => 'Messi', 'nip' => '1234567890'],
            ['code' => 'A07', 'name' => 'Kadimin', 'nip' => '1234567890'],
            ['code' => 'A08', 'name' => 'Sulastri', 'nip' => '1234567890'],
            ['code' => 'A09', 'name' => 'Tuqiyem', 'nip' => '1234567890'],
        ...
        $dm1Evaluations = [
            'A01' => [1, 4, 4, 2, 4],  // A1: C1=1, C2=4, C3=4, C4=2, C5=4
            'A02' => [1, 4, 3, 2, 4],  // A2
            'A03' => [1, 4, 4, 2, 4],  // A3
            'A04' => [1, 4, 3, 2, 4],  // A4
            'A05' => [1, 3, 3, 2, 5],  // A5
